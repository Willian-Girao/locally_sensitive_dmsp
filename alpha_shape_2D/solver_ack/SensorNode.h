...
public:
	...
	SensorNode(string instanceFileName, int sensorId, bool shouldDebug, int shouldDebugLevel, bool awaitAck, double radius);
	~SensorNode();
...
private:
	...
	bool backtracking;
	bool noAckAwait; //Lets both data mule and sensor know that they shouldn't await for ack msgs before any action
	bool noAckFlagHelperEnumerNodes;
